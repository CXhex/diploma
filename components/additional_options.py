...
class AdditionalOptions(CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.entry_slope_index_until_6 = CTkEntry(master=self, width=50, justify="center", fg_color="transparent", border_color='gray', state="disable")
        ...
        self.entry_slope_index_from_6_to_12 = CTkEntry(master=self, width=50, justify="center", fg_color="transparent", border_color='gray', state="disable")
        ...
        self.entry_slope_index_from_12_to_18 = CTkEntry(master=self, width=50, justify="center", fg_color="transparent", border_color='gray', state="disable")
